...
export function FilterBar({ meta, filters, employeeSelected, onMonthChange, onShiftChange, onHeadcountChange }: FilterBarProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      <span className="ml-auto text-[11px] text-[var(--text-3)]">
        {employeeSelected
          ? `Visão individual · taxa sobre os ${meta.workingDays} dias úteis do período`
